<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Accidentlogs.aspx.cs" Inherits="VASR_WEB.Accidentlogs" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

     <div class="row">
        
        <h3><strong>Accident Logs</strong></h3>
             ...
             <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="form-inline">
                            ...
                            <asp:TextBox ID="txtfilterAccidentRecord" placeholder="Enter Number" runat="server" CssClass="form-control" OnTextChanged="txtfilterAccidentRecord_TextChanged" AutoPostBack="true"></asp:TextBox>
                            <asp:Button ID="btnSearchAccidentRecord" runat="server" Text="Search" CssClass="btn btn-primary" />
        ...
        <br />
          ...
          <asp:ListView ID="lvAccidentLogs" runat="server" >
                <ItemTemplate>
                    <tr>
                        <td>
